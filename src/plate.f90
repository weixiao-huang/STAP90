...
! Allocate storage for element group data
  IF (IND == 1) THEN
      MM = 4*NUMMAT*ITWO + 13*NUME + 12*NUME*ITWO
...
SUBROUTINE late(ID,X,Y,Z,U,MHT,E,PR,THICK,LM,XYZ,MATP)
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
! .                                                                   .
...
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
  ...
  IMPLICIT NONE
  INTEGER :: ID(5,NUMNP),LM(12,NPAR(2)),MATP(NPAR(2)),MHT(NEQ)
  REAL(8) :: X(NUMNP),Y(NUMNP),Z(NUMNP),E(NPAR(3)),PR(NPAR(3)),  &
            THICK(NPAR(3)), XYZ(12,NPAR(2)),U(NEQ),UE(12)                           ! 在材料属性中添加了密度参数
  REAL(8) :: S(12,12),D(3,3),F,G,H,r,BS(2,12),alpha,Stemp(12,12)
!  REAL(8) :: 
